import type { components, Schema } from "@/directus-config/types/schema";
...
export const PUBLIC_DIRECTUS_URL = process.env.NEXT_PUBLIC_DIRECTUS_URL as string;
...
export function getDirectusImageUrl(
    ...
    return image
        ? `${PUBLIC_DIRECTUS_URL}/assets/${typeof image === "string" ? image : image.filename_disk}`
        : undefined;
}
